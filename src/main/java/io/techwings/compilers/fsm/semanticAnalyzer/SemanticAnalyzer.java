package io.techwings.compilers.fsm.semanticAnalyzer;

import io.techwings.compilers.fsm.parser.FsmSyntax;

import java.util.*;

import static io.techwings.compilers.fsm.parser.FsmSyntax.*;
import static io.techwings.compilers.fsm.semanticAnalyzer.SemanticStateMachine.*;
import static io.techwings.compilers.fsm.semanticAnalyzer.SemanticStateMachine.AnalysisError.ID.*;
